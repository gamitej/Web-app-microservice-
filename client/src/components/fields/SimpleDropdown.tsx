  ...
  return (
    <div ref={divRef} className="relative select-none">
      <span
        ...
        className={`px-4 py-2 hover:bg-gray-100 bg-white shadow border rounded-md text-xl flex justify-between items-center gap-4 w-[20rem] focus:ring-2 focus:ring-blue-300 text-gray-700 ${className}`}
      >
